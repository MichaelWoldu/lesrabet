...
if ( $_SESSION['logged_in'] != 1 ) {
  ...
  header("location: student/error.php");    
    ...
    $query = "SELECT jobs.title, jobs.company, jobs.app_deadline, responses.name FROM(( jobs INNER JOIN application ON application.jobs_id=jobs.id_jobs) INNER JOIN responses ON responses.id_responses = application.id_responses)  WHERE application.registered_id = '$applicant_id'";
...
<div style="height: auto;">
    <div class="container">
        <h1 align=center>Appicantion History:</h1>
    </div>
    </div>  
...
<div class='app-container'>
        <div class="row">
          <div class="col-md-9">
            <div class='header'>
            <h3><?= $app['title'] ?></h3>
            <span class='year'><i><?= $app['company'] ?></i></span>
            </div>
