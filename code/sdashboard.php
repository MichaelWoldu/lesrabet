...
if ( $_SESSION['logged_in'] != 1 ) {
  ...
  header("location: student/error.php");    
   ...
   // $queryy = "SELECT * FROM messages WHERE  studentId = '$applicant_id'";
    $queryy = "SELECT messages.companyId, messages.studentId, messages.jobTitle, messages.jobType, messages.jobId, messages.message, companys.company_name FROM ( messages INNER JOIN companys ON messages.companyId = companys.company_id)  WHERE  studentId = '$applicant_id'";
...
<?php include 'classes/nav.php';?>
    ...
    <div class="container">
        <h1 align=center>Welcome to your applicant dashboard</h1>
    </div>
	<div class="board">
     <div class="dashtab">
  		...
  		<button class="tablinks" onclick="viewDash(event, 'Application')">Application</button>
  		<button class="tablinks" onclick="viewDash(event, 'Messages')">Messages</button>
	 </div>
...
<div id="Welcome" class="dashcontent">
  ...
  <p> Once you are registered, we can prepare your University ID card so that it’s ready for you to pick up at the start of term. Once you have your card, you can access everything you need on campus, from meals to lectures.</p>
    ...
    <p align=right> The lesrabet team</p>
	  <hr>
	  <a href="mymessages.php">Need some help?</a>
</div>
</div>
   ...
   <a href="student/editProfile.php"><small><strong>Edit</strong></small></a>
      ...
      <br><hr>
        ...
        LinkedIn url
          ...
          <div class="col-sm-6">
             <a href="<?php echo $linkedIn; ?>" target="_blank">Click here to view profile</a>
                </div>
      </div>
      <br><hr>
...
<?php endfor; ?>
    <p align=right><a href="myapplications.php"> All my applications</a></p>
     ...
     <div id="Messages" class="dashcontent">
...
<div class='app-container'>
        <div class="row">
          <div class="col-md-9">
            <div class='header'>
            <h3><?= $app['jobTitle'] ?></h3>
            <span><h4><i><?= $app['company_name'] ?></i></h4></span>
            </div>
            <div><span><strong> Vacancy Type: </strong><?= $app['jobType']?></span></div>  
           </div>
           <div class="col-md-3">
               <br>
               <br>
               <div class='content description'><span><a href="<?= $app['name']?>"><strong> View all messages from <?= $app['company_name']?></strong> </a></span></div> 
           </div>
  </div>
    <hr>
    </div>
<?php endfor; ?>
    <p align=right><a href="myapplications.php"> All my messages</a></p>
</div>
	<script>
