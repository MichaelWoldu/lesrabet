...
<div class='app-container'>
    ...
    <div class="col-md-9">
            ...
            <span ><strong>University: </strong><?= $job['university'] ?></span><br>
            <span ><strong>Course: </strong><?= $job['course'] ?></span><br>
    </div>
   
        <a href='luckyApplicants.php?role=<?= $skill ?>&id=<?= $job["id"]?>&compid=<?= $company_id ?>'><font size="5.5em" align=center><strong>More detail!</strong></font></a>
        </div>
    <div class="col-md-3">
         <div ><strong>Top 5 Skills :</strong> <?= $job['skills']?></div>
