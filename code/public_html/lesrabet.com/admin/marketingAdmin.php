...
<?php include 'classes/nav.php';?>
	...
	<div class="board">
     <div class="dashtab">
  		...
  		<button class="tablinks" onclick="viewDash(event, 'Profile')">Pricing Packages</button>
  		<button class="tablinks" onclick="viewDash(event, 'Application')">Featured Companies</button>
...
<div id="Welcome" class="dashcontent">
  <div class="dashinfo">
    <h3>Hello,</h3>
  <p>You can also veiw all the other accounts. See the marketing and HR tools</p>
