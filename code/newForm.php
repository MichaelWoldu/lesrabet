...
<form method="post" action="apply.php">
        ...
        <input class="btn btn-default" type="text" name="fullName" id="fullName">
    </p>
    <p>
        <label for="jobDescription">Email Address:</label><br>
        <input class="btn btn-default" type="email" rows="10" cols="40" name="email" id="email" >
    </p>    
                <p>
        ...
        <input class="btn btn-default" type="text" rows="10" cols="40" name="university" id="university">
    </p>
                <p>
        ...
        <input class="btn btn-default" type="text" name="skill" id="skill">
