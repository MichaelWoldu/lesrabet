...
$sql = "SELECT title, job_description, app_deadline FROM jobs WHERE app_deadline > $today";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
    // output data of each row
    while($row = mysqli_fetch_assoc($result)) {
        echo "title: " . $row["title"]. " - Job Description: " . $row["job_description"]. " App Deadline: " . $row["app_deadline"]. "<br>";
    }
} else {
    echo "0 results";
}
...
<nav class="navbar navbar-inverse" style="margin-bottom: 0%;padding-bottom: 0%;">
  <div class="container-fluid">
	...
	<section class="container" align=right style="margin-top: 1em; margin-bottom: 1em; margin-left: 33%;">
			
				
		<form action="/php/search.php" method="post">
			<input type="text" class="btn btn-default" placeholder="Job">
	...
	<section class="result_section">
		<div class="row">
			<div class="col-sm-3" style="background-color:yellow; margin-left: 3%; padding-left: 1%;">
				 Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<br>
      Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
			</div>
			<div class="col-sm-8" style="background-color:pink; margin-left: 2%;">
